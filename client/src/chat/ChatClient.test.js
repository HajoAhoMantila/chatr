...
describe('Connecting and joining rooms', () => {
  test('When connecting sets nickname, connects with remote client and notifies', () => {
  ...
  test('Does not join using remote client when already has joined the room', () => {
  ...
  test('When joining a known room not yet joined, joins using remote client', () => {
    const room = 'RoomA';
...
describe('User join announcements', () => {
